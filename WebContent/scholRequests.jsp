...
<!-- Importing java script library -->
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
     <!-- Java script code to print the content present the HTML div element -->
    <script type="text/javascript">
        $("#btnPrint").live("click", function () {
            var divContents = $("#dvContainer").html();
            var printWindow = window.open('', '', 'height=400,width=800');
            printWindow.document.write('<html><head><title>Scholarship Requests</title>');
	...
	<div id="dvContainer">
		<%
			try {
				...
				String strQuery = "SELECT * FROM details where applied='yes'";
				//Executing the query
